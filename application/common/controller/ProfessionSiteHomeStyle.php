...
class ProfessionSiteHomeStyle extends BaseSiteHomeStyle
{
	
	public function loadMenu(&$baseSiteHome)
	{
		
		$baseSiteHome->assign('style', "sitehome@style/profession/base");
		// 正式环境加载菜单
		...
		if ($baseSiteHome->addon == 'DiyView' || (!empty($current_menu) && $current_menu['name'] == "APPLET_ROOT")) {
			$show_type = 'H5';
