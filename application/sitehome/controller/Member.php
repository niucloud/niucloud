...
//			$order = input('order', 'nm.member_id desc');
	...
	public function memberDetails()
	{
		...
		if (!empty($info['member_group'])) {
			$member_group_info = $member_model->getMemberGroupInfo([ 'site_id' => SITE_ID, 'group_id' => $info['member_group'] ], 'group_name');
		...
		return $this->fetch('member/member_details');
	}
	...
	public function labelList()
	{
		...
		return $this->fetch('member/label_list');
	}
	...
	public function levelList()
	{
		...
		return $this->fetch('member/level_list');
	}
	...
	public function accountConfig()
	{
		...
		return $this->fetch('member/account_config');
	}
	...
	public function agreement()
	{
		...
		if (IS_AJAX) {
			...
			return $this->fetch('member/agreement');
		}
	}
	...
	public function registerAndVisit()
	{
		...
		if (IS_AJAX) {
			...
			$this->assign('info', $config_result["data"]["value"]);
			return $this->fetch('member/register_and_visit');
		}
	}
