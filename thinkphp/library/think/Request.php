...
class Request
{
     ...
     */
    public function siteid($siteid = null)
    {
        if (!is_null($siteid)) {
            $this->siteid = $siteid;
            return $this;
     ...
     * @return string|Request
     */
    public function siteAddon($addon_name = null)
    {
        if (!is_null($addon_name)) {
            $this->siteAddon = $addon_name;
            return $this;
        } else {
            return $this->siteAddon ?: '';
        }
    }
    /**
     * 设置或者获取当前的模块名
