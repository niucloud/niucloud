...
use addon\system\Message\common\model\Message as MessageModel;
...
class WechatMessage
{
	...
	public function getMessageTemolateId($param){
        ...
        if($template_res->errcode == 0){
            ...
            return error($template_res, $template_res->errmsg);
        }
