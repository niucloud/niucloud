...
var table = new Table({
	elem: '#member_account',
	url: nc.url("Member://sitehome/member/accountDetail"),
	where: {
...
layui.use(['laytpl', 'form', 'laydate', 'element'], function () {
	...
	form.on('submit(editMemberInfoSubmit)', function (data) {
		...
		$.ajax({
			type: "post",
			async: false,
			url: nc.url("Member://sitehome/member/editMemberInfo"),
			dataType: 'json',
			data: data.field,
	...
	form.on('submit(memberGroupSubmit)', function (data) {
		$.ajax({
			type: "post",
			async: false,
			url: nc.url("Member://sitehome/member/modifyMemberGroup"),
			dataType: 'json',
			data: data.field,
			success: function (res) {
				back();
	...
	form.on('submit(formAccount)', function (data) {
		...
		$.ajax({
			type: "post",
			url: nc.url("Member://sitehome/member/setAccount"),
			data: field,
			dataType: 'json',
...
function setAccount() {
	$.ajax({
		type: "post",
		url: nc.url("Member://sitehome/member/memberInfo"),
		async: false,
