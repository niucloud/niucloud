...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
	...
	var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form,
		...
		m = ".layui-table-tool", mb = ".layui-table-bottom-tool", g = ".layui-table-box", b = ".layui-table-init",
	...
	I.prototype.config = {
		...
		// e.renderBottomToolbar()
		if (a.index = e.index, e.key = a.id || a.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(m), e.layBottomTool = o.find(mb), e.layBox = o.find(g), e.layHeader = o.find(x), e.layMain = o.find(C), e.layBody = o.find(k), e.layFixed = o.find(w), e.layFixLeft = o.find(T), e.layFixRight = o.find(A), e.layTotal = o.find(L), e.layPage = o.find(N), e.renderToolbar(), e.fullSize(), a.cols.length > 1) {
	...
	}, I.prototype.renderBottomToolbar = function () {
		...
		if ("string" == typeof a.bottomToolbar) {
		...
		return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ? g() : 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), g(), c.renderTotal(y),c.renderBottomToolbar(), c.renderForm(), void(s.page && (s.page = t.extend({
		...
		var ee = this, tt = e.config, ii = ee.layBottomTool.find('input[name="layTableCheckbox"]'), aa = function (i) {
		...
		ii[0] && (d.checkStatus(ee.key).isAll ? (ii[0].checked || (ii.prop("checked", !0), ee.renderForm("checkbox")), aa(!0)) : (ii[0].checked && (ii.prop("checked", !1), ee.renderForm("checkbox")), aa(!1)))
		...
		}), a.layBottomTool.on("click", "*[lay-event]", function (e) {
			var i = t(this), c = i.attr("lay-event");
			layui.event.call(this, y, "bottomToolbar(" + p + ")", t.extend({event: c, config: o}, {}))
