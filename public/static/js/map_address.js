...
mapClass.prototype = {
    init : function(id, lnglat, map_success_back){
        ...
        if(lnglat["lat"] != ''|| lnglat["lng"] != '' ){
            msp_json["center"] = [lnglat["lat"], lnglat["lng"]]//初始化地图中心点}
        }
    ...
    mapChange : function(address){
        ...
        if (_this.map_change) {
                ...
                var address_detail = _this.address.province > 0 && _this.address.city > 0 && _this.address.district > 0 && _this.address.township > 0 ? _this.address.address : '';
                if(!address){
